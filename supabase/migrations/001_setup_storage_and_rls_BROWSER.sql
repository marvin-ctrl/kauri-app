-- Migration: Setup Storage and Row Level Security (Browser-Compatible Version)
-- Created: 2025-10-26
-- Description: Adds player photo storage support and implements RLS policies
-- NOTE: Storage bucket policies must be configured through Supabase Dashboard UI
...
-- NOTES
-- ============================================================================
-- Storage bucket policies must be configured through the Supabase Dashboard UI:
-- 1. Go to Storage → player-photos → Policies
-- 2. Add policies for INSERT, SELECT, UPDATE, DELETE
-- 3. Set target roles to "authenticated"
-- See SUPABASE_STORAGE_DEPLOYMENT.md for detailed instructions
