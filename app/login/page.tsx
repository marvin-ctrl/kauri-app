        ...
        <div className="bg-white border-2 border-[#79CBC4] rounded-2xl shadow-2xl p-8">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <input
              ...
              className="w-full px-4 py-3 border-2 border-[#e2e8f0] rounded-lg focus:outline-none focus:border-[#79CBC4] focus:ring-2 focus:ring-[#79CBC4]/20 bg-white text-black transition-all"
            />
