    ...
    <Link
      ...
      className={[
        ...
        active
          ...
          : 'bg-white text-black hover:bg-[#79CBC4] border border-[#e2e8f0]', // light/teal bg → black text
    ...
    <nav className="w-full border-b border-[#e2e8f0] bg-white shadow-sm">
      <div className="max-w-6xl mx-auto flex items-center justify-between p-3 gap-3">
        <div className="flex items-center gap-3">
          <Link
            href="/dashboard"
            className="text-xl font-extrabold tracking-tight text-black hover:text-[#79CBC4] transition-colors"
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            onClick={signOut}
            className="px-3 py-2 rounded-md text-sm font-semibold bg-[#F289AE] text-black hover:bg-[#e5679a] transition-all shadow-sm"
          >
            Sign out
          </button>
        </div>
