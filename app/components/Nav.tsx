...
index d83e12bd16d7afb611c7a7e1ddf8b9558b24b031..f41817e5283a1c76eb43f8739257c61b967480ff 100644
...
+    <nav className="brand-nav sticky top-0 z-40 border-b border-white/20">
...
+          {LINKS.map(link => (
+            <NavLink key={link.href} pathname={pathname} onNavigate={() => setOpen(false)} className="w-full" {...link} />
+          ))}
+        </div>
+      )}
     </nav>
